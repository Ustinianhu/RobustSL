#!/usr/bin/env python3
"""Run balanced no-defense GTSRB experiments for high utility and stronger BA."""
...
RUN_ROOT = ROOT / 'client_count_no_defense_balanced_runs'
SUMMARY_CSV = ROOT / 'client_count_no_defense_results_balanced.csv'
SUMMARY_MD = ROOT / 'client_count_no_defense_results_balanced.md'
...
def write_results(rows: list[dict]) -> None:
    ...
    lines = [
        ...
        'Balanced stronger attack: PMR=10%, poison rate=1.0, attack scale=1.5, trigger size=8, without `--enable-defense`.', '',
